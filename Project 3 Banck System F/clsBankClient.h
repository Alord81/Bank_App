...
{
	//Date - Time#//#From#//#To#//#Amount#//#AfterAccountBalanceFrom#//#AfterAcconutBalanceTo#//#User
...
public:
	...
	bool Transfer(double Amount, clsBankClient& DestinationClient)
	{
		...
		stTransferRecord Record = clsBankClient::TranferRecord(getAccountNumber(), DestinationClient.getAccountNumber(),
			AccountBalance, DestinationClient.AccountBalance, Amount);
	...
	static stTransferRecord TranferRecord(string SourceClient, string DestinationClient, double BalanceSourceAfterTransfer, double BalanceDestinationAfterTransfer, double Amount)
	{
